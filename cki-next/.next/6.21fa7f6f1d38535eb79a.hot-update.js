...
function (_Component6) {
  ...
  function CardArea(props) {
    ...
    _this.eachNote = _this.eachNote.bind(_assertThisInitialized(_this));
  ...
  _createClass(CardArea, [{
    ...
    value: function add(text) {
      ...
      this.setState(function (prevState) {
        return {
          notes: _toConsumableArray(prevState.notes).concat([{
            id: _this2.nextId(),
            note: text
          }])
        };
    ...
    value: function eachNote(note, i) {
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Note, {
        key: note.id,
        index: note.id,
    ...
    value: function render() {
      ...
      }, this.state.notes.map(this.eachNote), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("button", {
  ...
  _createClass(Card, [{
    ...
    value: function componentWillMount() {
      this.style = {
        ...
        transform: "rotate(".concat(this.randomBetween(-25, 25, 'deg'), ")")
      };
    }
  }, {
    key: "randomBetween",
    ...
    value: function renderForm() {
      ...
      }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(FaFloppyO, {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 231
        }
    ...
    value: function renderDisplay() {
      ...
      }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(FaPencil, {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 242
        }
      ...
      }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(FaTrash, {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 243
        }
...
//# sourceMappingURL=6.21fa7f6f1d38535eb79a.hot-update.js.map