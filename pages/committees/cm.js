		...
		return(
    			<div>
	    			<div className="content">
		    			<h1>Communications & Marketting</h1>

		    			<Profiles />

		    			<hr />
		    			<p className="textbox">
		    			Hey everyone! We're your Communications and Marketing committee (C&M for short) and serve as your Public Relations, Graphics, and Campus Outreach chairs! Whenever there's a promotion for the club, we are the backbone behind it. You can find us posting on our social media sites (check out @uclacki ;)), making awesome graphics to announce events, or reaching out to current and prospective members!
		    			</p>
					</div>
